...
controller_eno=$7
compute_eno=$8
echo $controller | sed -i "s/slave1/${controller}/g" /root/openstack/*
echo $compute | sed -i "s/slave2/${compute}/g" /root/openstack/*
echo $controller_ip | sed -i "s/controller_ip/${controller_ip}/g" /root/openstack/installcinder_master.sls /root/openstack/installneu_master.sls /root/openstack/installnova_master.sls
